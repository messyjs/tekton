// ============================================================================
// SmartHome Plate™ — Rear Panel Left (Polycarbonate, CNC Routed)
// ============================================================================
// Panel D: Left diagonal panel, 12" (304.8mm) wide
// This panel faces the left-back direction at 45°
// ============================================================================
...
module rear_panel_left() {
    difference() {
        // Main panel — diagonal width
