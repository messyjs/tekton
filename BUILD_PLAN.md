...
- [ ] Terminal -- Full PTY via xterm.js (TerminalManager, REST API + WebSocket I/O, xterm.js frontend, session management)
- [ ] Files -- Browser + Monaco Editor (FileManager backend done, textarea editor in SPA done; Monaco upgrade future)
