...
export class TTSManager {
    ...
    constructor(config, outputDir) {
        ...
        const providers = ["edge", "elevenlabs", "openai", "neutts"];
    ...
    async synthesizeWithProvider(provider, text, outputPath, voice) {
        switch (provider) {
    ...
    async synthesizeEdge(text, outputPath, voice) {
    ...
    // ── ElevenLabs ────────────────────────────────────────────────────
    async synthesizeElevenLabs(text, outputPath, voice) {
    ...
    // ── OpenAI TTS ────────────────────────────────────────────────────
    async synthesizeOpenAI(text, outputPath, voice) {
    ...
    // ── NeuTTS (espeak-ng) ────────────────────────────────────────────
    async synthesizeNeuTTS(text, outputPath, voice) {
