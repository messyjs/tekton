...
// ── Types & Constants ────────────────────────────────────────────────
import { DEFAULT_VOICE_CONFIG, WHISPER_HALLUCINATIONS, } from "../src/types.js";
describe("Voice Types & Constants", () => {
    ...
    it("STTProvider type accepts valid values", () => {
        const providers = ["local", "groq", "openai"];
    ...
    it("RecordingState type accepts valid values", () => {
        const states = ["idle", "confirming", "recording", "processing"];
