 ...
 */
export async function focusWindowByTitle(title) {
    const script = `
    Add-Type @"
    using System;
 ...
 */
export async function sendHotkeyToWindow(title, combo) {
 ...
 */
export async function typeTextSlow(text, delay = 20) {
    try {
        const script = `
      Add-Type -AssemblyName System.Windows.Forms
...
//# sourceMappingURL=protocol-hotkey.js.map