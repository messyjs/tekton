...
export { discoverApps, scanProcesses, scanCDPPorts, scanOSCPorts, scanMIDIPorts, identifyApp, determineProtocol, getCDPTargets, } from "./process-scanner.js";
export { DEFAULT_KNOWN_APPS, DEFAULT_APP_DRIVER_CONFIG } from "./types.js";
export { CDPDriver } from "./protocol-cdp.js";
export { UIADriver, listWindows, findWindow, focusWindow, getControls, takeScreenshot, } from "./protocol-uia.js";
export type { UIWindow } from "./protocol-uia.js";
export { focusWindowByTitle, sendHotkey, sendHotkeyToWindow, typeTextSlow, pasteText, pressKey, toSendKeys, COMMON_SHORTCUTS, } from "./protocol-hotkey.js";
export { MIDIDriver, CC_NUMBERS, MASSIVE_CC_MAP, SYNTH_CC_MAPS, SCALES, CHORDS, noteToMidi, midiToNote, percentToMidi, midiToPercent, } from "./protocol-midi.js";
export { OSCDriver, ABLETON_OSC_ADDRESSES, FL_STUDIO_OSC_ADDRESSES, REAPER_OSC_ADDRESSES, encodeOSCMessage, decodeOSCMessage, encodeOSCBundle, toNTPTimetag, getOSCAddressMap, } from "./protocol-osc.js";
export type { ProtocolLayer, AppProcess, DiscoveredApp, ControlAction, ControlResult, SurfaceControl, SurfaceMap, AppDriverConfig, AppPattern, } from "./types.js";
