...
export const EXPANDED_PROVIDERS: Record<string, ProviderConfig> = {
  ...
  ollama: {
    ...
    models: [
      ...
      { id: "gemma4:26b", name: "Gemma 4 26B", type: "deep", costTier: "free", contextWindow: 131072, maxOutputTokens: 8192, latencyRange: "5-25s" },
      { id: "gemma4:e4b", name: "Gemma 4 E4B (8B)", type: "fast", costTier: "free", contextWindow: 131072, maxOutputTokens: 8192, latencyRange: "0.5-3s" },
      { id: "gemma4:e2b", name: "Gemma 4 E2B (5B)", type: "fast", costTier: "free", contextWindow: 131072, maxOutputTokens: 8192, latencyRange: "0.3-1.5s" },
      { id: "qwen3.5:9b", name: "Qwen 3.5 9B", type: "fast", costTier: "free", contextWindow: 65536, maxOutputTokens: 8192, latencyRange: "1-5s" },
      { id: "qwen3.5:4b", name: "Qwen 3.5 4B", type: "fast", costTier: "free", contextWindow: 32768, maxOutputTokens: 4096, latencyRange: "0.3-2s" },
      { id: "glm-4.7-flash:latest", name: "GLM 4.7 Flash (30B)", type: "deep", costTier: "free", contextWindow: 131072, maxOutputTokens: 16384, latencyRange: "3-15s" },
      { id: "glm-ocr:latest", name: "GLM OCR (1.1B)", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 4096, latencyRange: "0.2-1s" },
      { id: "lfm2.5-thinking:latest", name: "LFM 2.5 Thinking (1.2B)", type: "reasoning", costTier: "free", contextWindow: 32768, maxOutputTokens: 4096, latencyRange: "0.5-3s" },
      { id: "granite4.1:8b", name: "Granite 4.1 8B", type: "fast", costTier: "free", contextWindow: 131072, maxOutputTokens: 8192, latencyRange: "1-5s" },
      { id: "granite4.1:3b", name: "Granite 4.1 3B", type: "fast", costTier: "free", contextWindow: 32768, maxOutputTokens: 4096, latencyRange: "0.3-2s" },
    ],
  ...
  "ollama-laptop": {
    ...
    models: [
      { id: "glm-5.1:cloud", name: "GLM 5.1 Cloud", type: "deep", costTier: "free", contextWindow: 202752, maxOutputTokens: 16384, latencyRange: "1-5s" },
      { id: "deepseek-v4-flash:cloud", name: "DeepSeek V4 Flash Cloud", type: "deep", costTier: "free", contextWindow: 131072, maxOutputTokens: 16384, latencyRange: "1-5s" },
      { id: "gemma3:1b", name: "Gemma 3 1B", type: "fast", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "0.2-1s" },
      { id: "deepseek-r1:1.5b", name: "DeepSeek R1 1.5B", type: "reasoning", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "0.5-3s" },
      { id: "llama3.2:1b", name: "Llama 3.2 1B", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 4096, latencyRange: "0.2-1s" },
      { id: "qwen3:1.7b", name: "Qwen 3 1.7B", type: "fast", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "0.3-2s" },
      { id: "lfm2.5-thinking:1.2b", name: "LFM 2.5 Thinking 1.2B", type: "reasoning", costTier: "free", contextWindow: 32768, maxOutputTokens: 4096, latencyRange: "0.5-3s" },
      { id: "codegemma:2b", name: "CodeGemma 2B", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 4096, latencyRange: "0.2-1s" },
      { id: "exaone-deep:2.4b", name: "ExaOne Deep 2.4B", type: "reasoning", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "0.5-3s" },
      { id: "stablelm2:1.6b", name: "StableLM 2 1.6B", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 4096, latencyRange: "0.2-1s" },
      { id: "deepcoder:1.5b", name: "DeepCoder 1.5B", type: "fast", costTier: "free", contextWindow: 16384, maxOutputTokens: 4096, latencyRange: "0.3-2s" },
      { id: "opencoder:1.5b", name: "OpenCoder 1.5B", type: "fast", costTier: "free", contextWindow: 16384, maxOutputTokens: 4096, latencyRange: "0.3-2s" },
      { id: "deepseek-coder:1.3b", name: "DeepSeek Coder 1.3B", type: "fast", costTier: "free", contextWindow: 16384, maxOutputTokens: 4096, latencyRange: "0.3-2s" },
      { id: "tinyllama:1.1b", name: "TinyLlama 1.1B", type: "fast", costTier: "free", contextWindow: 4096, maxOutputTokens: 2048, latencyRange: "0.1-0.5s" },
      { id: "falcon3:1b", name: "Falcon 3 1B", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 4096, latencyRange: "0.2-1s" },
      { id: "granite3-moe:1b", name: "Granite 3 MoE 1B", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 2048, latencyRange: "0.2-1s" },
      { id: "granite3.1-moe:1b", name: "Granite 3.1 MoE 1B", type: "fast", costTier: "free", contextWindow: 8192, maxOutputTokens: 2048, latencyRange: "0.2-1s" },
      { id: "guzesqdro/Claude_Sonnet_4.6_Reduced:latest", name: "Claude Sonnet 4.6 Reduced", type: "deep", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "1-5s" },
      { id: "cryptidbleh/gemma4-claude-opus-4.6:latest", name: "Gemma4 Claude Opus 4.6", type: "deep", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "1-5s" },
      { id: "evanollama/qwen3.5-opus-4.7-distilled:latest", name: "Qwen3.5 Opus 4.7 Distilled", type: "deep", costTier: "free", contextWindow: 32768, maxOutputTokens: 8192, latencyRange: "1-5s" },
    ],
    apiMode: "chat_completions",
    local: true,
    latency: 2000,
  ...
  zhipu: {
    ...
    models: [
      ...
      { id: "glm-4.7-flash", name: "GLM 4.7 Flash", type: "deep", costTier: "low", contextWindow: 131072, maxOutputTokens: 16384, latencyRange: "1-5s" },
...
export const MODEL_PRICING: Record<string, { input: number; output: number }> = {
  ...
  "lfm2.5-thinking:latest":{ input: 0, output: 0 },
  "granite4.1:8b":         { input: 0, output: 0 },
  "granite4.1:3b":         { input: 0, output: 0 },
};
