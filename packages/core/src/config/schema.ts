...
export const CONFIG_SCHEMA = Type.Object({
  ...
  fusion: Type.Object({
    ...
    models: Type.Array(Type.Object({
      ...
      role: Type.Union([Type.Literal("primary"), Type.Literal("secondary"), Type.Literal("judge"), Type.Literal("specialist")], { default: "primary" }),
      active: Type.Boolean({ default: true }),
    }), { default: [] }),
    maxConcurrent: Type.Number({ default: 3 }),
    timeoutMs: Type.Number({ default: 60000 }),
    minModels: Type.Number({ default: 2 }),
    useOpenRouterPlugin: Type.Boolean({ default: true }),
    qualityThreshold: Type.Number({ default: 0.85 }),
    autoSelect: Type.Boolean({ default: true }),
    trackEffectiveness: Type.Boolean({ default: true }),
    maxExtraCost: Type.Number({ default: 0.05 }),
    useJudge: Type.Boolean({ default: true }),
    judgeModel: Type.String({ default: "gpt-4.1-mini" }),
      uncensoredMode: Type.Boolean({ default: false }),
  }),
  session: Type.Object({
