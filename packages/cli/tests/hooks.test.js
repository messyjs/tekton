...
import { createOnPromptHook } from "../src/hooks/on-prompt.js";
...
describe("Hooks", () => {
    ...
    describe("on-session hook", () => {
        it("creates an extension factory that registers listeners and commands", () => {
            ...
            const commandNames = mockPi.registerCommand.mock.calls.map((call) => call[0]);
