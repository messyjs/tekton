    ...
    return {
        ...
        handler: async (args, ctx, pi, piCtx) => {
            ...
            switch (sub) {
                ...
                case "stop": {
                    if (!_voiceManager) {
                        piCtx.ui.notify("❌ Voice not available.");
                        return;
                    }
                    try {
                ...
                case "providers": {
                    ...
                    piCtx.ui.notify("🎙️ STT Providers:\n" +
                ...
                default: {
                    piCtx.ui.notify("🔊 Voice Management\n\n" +
                        "Subcommands:\n" +
                        "  on        Enable voice mode\n" +
                        "  off       Disable voice mode\n" +
...
//# sourceMappingURL=tekton-voice.js.map