...
import { compress, estimateTokens } from "@tekton/core";
            ...
            switch (sub) {
                ...
                default: {
                    ...
                    if (hasJsonFlag(args)) {
                        ...
                        piCtx.ui.notify(`Compression stats: ${stats.totalSaved} tokens saved\n` +
...
//# sourceMappingURL=tekton-compress.js.map