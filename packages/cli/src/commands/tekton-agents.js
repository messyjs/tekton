import { hasJsonFlag, formatTable } from "./types.js";
export function createAgentsCommand(getPool) {
    return {
        name: "tekton:agents",
        ...
        handler: async (args, _ctx, _pi, piCtx) => {
            ...
            switch (sub) {
                case "list": {
                    ...
                    piCtx.ui.notify(formatTable(["Name", "ID", "State", "✓", "✗", "Tokens"], rows));
                    return;
                }
                case "log": {
                    if (!pool) {
                    ...
                    const lines = ["Agent Event Log:", "─".repeat(50)];
                ...
                case "spawn": {
                    ...
                    const skillHint = typeof args.flags.skill === "string" ? args.flags.skill : undefined;
                ...
                case "status": {
                    ...
                    piCtx.ui.notify("Agent Pool Status\n" +
                        "─".repeat(30) + "\n" +
                ...
                case "route": {
                    ...
                    piCtx.ui.notify(`${strategyEmoji} Routing Decision\n` +
                        "─".repeat(30) + "\n" +
                ...
                default: {
                    if (!pool) {
                        piCtx.ui.notify("Sub-Agent Management\n\n" +
...
//# sourceMappingURL=tekton-agents.js.map