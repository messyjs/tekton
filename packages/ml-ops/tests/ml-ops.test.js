...
import { parseTrainingPrompt, buildTrainingConfig } from "../src/config-builder.js";
...
import { generateQLoRAScript, generateTernaryScript, generateGRPOScript, generateEvalScript, } from "../src/python-templates.js";
...
describe("ConfigBuilder", () => {
    ...
    it("builds default config from spec", () => {
        const spec = { method: "qlora", baseModel: "test/model" };
...
describe("CheckpointManager", () => {
    ...
    it("tracks best checkpoint", () => {
        ...
        const job = {
            id: "best-job", name: "test", method: "qlora", status: "running",
    ...
    it("deletes checkpoints", () => {
        ...
        const job = {
            id: "del-job", name: "test", method: "qlora", status: "running",
    ...
    it("cleans up old checkpoints", () => {
        ...
        const job = {
            id: "cleanup-job", name: "test", method: "qlora", status: "running",
...
//# sourceMappingURL=ml-ops.test.js.map