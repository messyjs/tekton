...
export class CheckpointManager {
    ...
    saveCheckpoint(job, step, trainLoss, evalLoss) {
    ...
    async exportCheckpoint(checkpointId, format = "gguf") {
    ...
    // ── Private ──────────────────────────────────────────────────────────
    checkBestCheckpoint(jobId, newCheckpoint) {
    ...
    exportToGGUF(checkpoint, exportDir) {
...
`;
    ...
    exportToSafetensors(checkpoint, exportDir) {
        const script = `#!/usr/bin/env python3
...
`;
    ...
    generateExportScript(checkpoint, format, exportDir) {
