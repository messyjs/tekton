...
import os from "os";
import { ScribePool } from "../../src/continuity/scribe-pool.js";
...
describe("formatAsContext", () => {
    it("formats handoff into readable context", () => {
        const handoff = {
            ...
            filesModified: [{ path: "src/header.tsx", action: "created", status: "beta", hash: "abc" }],
...
describe("ResetOrchestrator", () => {
    ...
    it("provides handoff context for fresh session", async () => {
        ...
        writeFileSync(join(tmpDir, "handoffs", "task-test-1-1000.json"), JSON.stringify(handoff, null, 2));
