...
import { SessionRunner, type SessionResult } from "../../src/production/session-runner.js";
import type { AgentTuple, TaskCard, RoleDefinition, SessionBudget } from "../../src/types.js";
import { createBudget, increment } from "../../src/session-budget.js";

function makeTaskCard(): TaskCard {
  return {
    id: "tc-session-test",
    planId: "plan-test",
