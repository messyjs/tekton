...
import { ProductionManager } from "./production/production-manager.js";
import { QAManager } from "./qa/qa-manager.js";
        ...
        try {
            ...
            while (qaResult.verdict === "fail" && qaCycle < maxCycles) {
                ...
                if (retryCards.length > 0) {
                    const retryPlan = { ...plan, taskCards: retryCards };
            ...
            state.error = `Pipeline error: ${e.message}`;
            state.updatedAt = Date.now();
            this.saveState(projectDir, state);
            return projectId;
        }
...
//# sourceMappingURL=forge-runtime.js.map