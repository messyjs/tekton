 ...
 */
export function markAsBeta(projectDir, filePath) {
 ...
 */
export function isBetaFile(path) {
 ...
 */
export function getOriginalName(betaPath) {
 ...
 */
export function listBetaFiles(projectDir) {
...
//# sourceMappingURL=beta-file-manager.js.map