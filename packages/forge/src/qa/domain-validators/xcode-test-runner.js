...
export async function runXcodeTests(projectDir, scheme) {
    ...
    try {
        ...
        const output = execSync(`xcodebuild test ${schemeArg} -destination 'platform=iOS Simulator,name=iPhone 15' -quiet`, {
            cwd: projectDir,
...
//# sourceMappingURL=xcode-test-runner.js.map