 ...
 */
export function markBeta(projectDir, filePath) {
 ...
 */
export function markTesting(projectDir, filePath) {
 ...
 */
export function promote(projectDir, filePath, manifest) {
    ...
    if (!hasPassed) {
        throw new Error(`Cannot promote "${fileName}" to release: no passing QA signoffs found. ` +
 ...
 */
export function getStatus(projectDir, filePath) {
