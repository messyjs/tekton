 ...
 */
export function loadLatestHandoff(projectDir, taskCardId) {
 ...
 */
export function formatAsContext(handoff) {
    const sections = [];
 ...
 */
export function extractPrecisionItemsFromHandoff(handoff) {
    const items = [];
    let index = 0;
...
//# sourceMappingURL=handoff-loader.js.map