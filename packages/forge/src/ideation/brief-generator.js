 ...
 */
export async function generateBrief(transcript, callLLM) {
 ...
 */
function templateExtract(transcript) {
...
function extractSection(transcript, keywords, fallback) {
...
function detectDomains(transcript) {
    const lower = transcript.toLowerCase();
    const domains = [];
...
//# sourceMappingURL=brief-generator.js.map