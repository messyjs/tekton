...
const DEFAULT_PERSONAS = [strategist, architect, uxThinker];
/**
...
export class CreativeTeam {
    ...
    selectPersona(userMessage, phase) {
     ...
     */
    async getNextResponse(userMessage, responseGenerator) {
    ...
    async generateBrief(responseGenerator) {
...
//# sourceMappingURL=creative-team.js.map