...
export const architect = {
    ...
    speakingStyle: "Analytical, thinks in systems and components. Evaluates technical feasibility, identifies hard problems early, suggests technology choices with tradeoffs.",
    questionTypes: [
