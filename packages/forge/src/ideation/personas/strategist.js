...
export const strategist = {
    ...
    speakingStyle: "Direct, asks probing questions about market fit and user needs. Focuses on who the user is, what problem exists, and why this solution matters. Challenges vague ideas with specific questions.",
    questionTypes: [
        "Who is this for?",
