 ...
 */
export const uxThinker = {
    name: "Sage",
    role: "UX Thinker",
    speakingStyle: "Empathetic, user-focused. Thinks about flows, friction, accessibility, and delight. Pushes back when technical decisions hurt user experience.",
    questionTypes: [
