 ...
 * and QA gates.
 */
export type { ProductDomain, ProductBrief, RevisionNote, DirectorVerdict, DirectorDecision, ProductionPlan, TaskCard, TaskCardStatus, TeamTemplate, RoleDefinition, TestRoleDefinition, AgentTuple, SessionRecord, SessionRecordStatus, HandoffPackage, FileChange, FileChangeAction, FileChangeStatus, ForgeManifest, ForgePhase, ArtifactEntry, ArtifactStatus, QASignoff, PreflightResult, } from "./types.js";
