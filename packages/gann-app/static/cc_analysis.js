function AnalysisPage(props) {
  ...
  if (error) return e('div', {className:'page'},
    e('div', {className:'hero'}, e('div', null, e('div', {className:'hero-score', style:{background:'#f43f5e',WebkitBackgroundClip:'unset',WebkitTextFillColor:'unset',color:'#fff'}}, '!'), e('div', {className:'hero-bias', style:{color:'var(--red)'}}, 'ERROR'))),
  ...
  // Safely render a component - show error card if it crashes
