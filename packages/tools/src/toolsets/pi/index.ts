...
export const piGannAnalyzeTool: ToolDefinition = {
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.gannAnalyze(params as any);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piGannLevelsTool: ToolDefinition = {
  name: "pi_gann_levels",
  toolset: "pi",
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.gannLevels(params as any);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piGannPlanetaryTool: ToolDefinition = {
...
export const piGannRangeTool: ToolDefinition = {
  name: "pi_gann_range",
  toolset: "pi",
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.gannRange(params as any);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piFibAnalyzeTool: ToolDefinition = {
  name: "pi_fib_analyze",
  toolset: "pi",
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.fibAnalyze(params as any);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piTradeSignalTool: ToolDefinition = {
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.tradeSignal(params as any);
    // Record the signal
...
export const piGlmAskTool: ToolDefinition = {
  name: "pi_glm_ask",
  toolset: "pi",
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.glmAsk(params as any);
    return { content: result.answer };
  },
};

export const piQuoteTool: ToolDefinition = {
  name: "pi_quote",
  toolset: "pi",
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.tvQuote(params.symbol as string);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piDataTool: ToolDefinition = {
  name: "pi_data",
  toolset: "pi",
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.tvData(params as any);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piExecuteTradeTool: ToolDefinition = {
  ...
  async execute(params): Promise<ToolResult> {
    const result = await defaultPiAgent.tvExecuteTrade(params as any);
    return { content: JSON.stringify(result, null, 2) };
  },
};

export const piPositionsTool: ToolDefinition = {
  name: "pi_positions",
  toolset: "pi",
...
export const piTradeHistoryTool: ToolDefinition = {
...
export const piStatusTool: ToolDefinition = {
  name: "pi_status",
  toolset: "pi",
